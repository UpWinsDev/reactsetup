...
const Agendar : React.FC = () => {
  ...
  const Menus = [
    ...
    { title: "Agendar", src: "User", gap: true },
    { title: "Prontuário ", src: "Calendar" },
  ...
  return (
    <div className="flex">
      <div className={` ${open ? "w-52" : "w-16 "} bg-blue-900 h-screen p-3 pt-5 relative duration-300`}>
  ...
  <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
      ...
      <div className="h-screen flex-1 p-7">
        <h1 className="text-2xl text-white font-semibold ">Home Page</h1>
      </div>
    </div>
  );
};
